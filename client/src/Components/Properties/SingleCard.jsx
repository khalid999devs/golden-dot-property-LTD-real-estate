...
const SingleCard = ({ img, heading, subText, value }) => {
  const navigate = useNavigate();

  return (
    <div
      className='min-w-[260px] max-w-[320px] sm:max-w-[300px] w-full h-[380px] relative group cursor-pointer'
      onClick={() => {
    ...
    >
      <div className='w-full h-full img-sec overflow-hidden'>
        <img
          ...
          alt={heading}
          className='w-full scale-105  group-hover:scale-110 group-hover:grayscale-[0] h-full object-cover transition-transform duration-1000 grayscale-[40%]'
        />
      </div>
